...
clang ../benchmarks/fact_sum/fact_sum.c -O3 -Wno-parentheses-equality
...
clang ../benchmarks/Fibonacci/Fibonacci.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/binaryConverter/binaryConverter.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/hailstone/hailstone.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/primes/primes.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/programBreaker/programBreaker.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/wasteOfCycles/wasteOfCycles.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/OptimizationBenchmark/OptimizationBenchmark.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/mixed/mixed.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/uncreativeBenchmark/uncreativeBenchmark.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/TicTac/TicTac.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/mile1/mile1.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/GeneralFunctAndOptimize/GeneralFunctAndOptimize.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/killerBubbles/killerBubbles.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/hanoi_benchmark/hanoi_benchmark.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/stats/stats.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/biggest/biggest.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/creativeBenchMarkName/creativeBenchMarkName.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/bert/bert.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
...
clang ../benchmarks/BenchMarkishTopics/BenchMarkishTopics.c -O3 -Wno-parentheses-equality
dstart=$(date +'%Y-%m-%d %H:%M:%S|%N')
ms=$(( ${dstart#*|}/1000000 ))
dstart="${dstart%|*}.$ms"
echo "start:" $dstart
